        ...
        <form onSubmit={handleSubmit} className={`space-y-6 ${isSubmitting || isUploading ? 'pointer-events-none opacity-70' : ''}`}>
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-1 mb-3">
              ...
              <input 
                className="h-10 px-3 text-body-md border border-outline-variant focus:border-primary rounded outline-none transition-colors w-full bg-white text-on-surface focus:ring-1 focus:ring-primary" 
